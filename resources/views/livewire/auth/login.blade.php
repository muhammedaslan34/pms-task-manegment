<div class="mx-auto flex max-w-md flex-col justify-center py-10">
    <div class="text-center">
        <h1 class="font-display text-2xl font-bold text-brand">{{ __('Support Login') }}</h1>
        <p class="mt-1 text-sm text-slate-500">{{ __('Sign in to manage incoming tasks.') }}</p>
    </div>

    <form wire:submit="login" class="mt-8 space-y-6 rounded-2xl border border-slate-200/80 bg-white p-7 shadow-sm">
        <div>
        ...
        <button type="submit"
            class="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-800 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-900 focus:ring-2 focus:ring-blue-800 focus:ring-offset-2 disabled:opacity-50"
